    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            else if (lbl_Status.Text == "添加") //如果是“添加”状态
            {
                ...
                string str = string.Format("insert into Customer_Info values(DEFAULT,'{0}','{1}','{2}','{3}','{4}','{5}')", name, company, sex, age, telephone, address);
        ...
        protected void DataBind_Customer()
        {
            ...
            {
                ListViewItem myitem = new ListViewItem(dr["CustomerID"].ToString());// 创建一个ListViewItem 项，并为第 1 列赋值，客户编号
